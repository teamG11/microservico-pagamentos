...
export function BuscarTodosPedidosNaoFinalizadosUseCaseFactory(
  pedidoGateway: IPedidoGateway
) {
  const buscaTodosPedidosNaofinalizados =
    new BuscaTodosPedidosNaoFinalizadosUseCase(pedidoGateway);
